            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="customer-login text-left">
                        <form method="POST" class="" action="<?php echo base_url(); ?>auth/login">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <p><a href="<?= base_url('auth/register'); ?>" class="text-gray">Register</a></p>
                                </div>
                                <div class="col-6">
                                    <!-- <p><a href="<?= base_url('auth/forgotpassword'); ?>" class="text-gray">Forget your password?</a></p> -->
                                </div>
                            </div>
